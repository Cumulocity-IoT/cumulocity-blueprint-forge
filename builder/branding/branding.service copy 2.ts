...
`;
            ...
            if (app.applicationBuilder.branding && app.applicationBuilder.branding.enabled && app.applicationBuilder.branding.colors
                && (app.applicationBuilder.branding.colors.primary === '#ffffff' ||
                    app.applicationBuilder.branding.colors.primary === '#fff' ||
                    app.applicationBuilder.branding.colors.primary === '#f9fafb' ||
                    app.applicationBuilder.branding.colors.primary === 'white')) {
...
body {
   ...
   // --brand-dark: ${this.colorToHex(app.applicationBuilder.branding.colors.text)};
    ...
    /*1017 changes */
     --text-color:  ${this.colorToHex(app.applicationBuilder.branding.colors.text)};
     --header-text-color:  ${this.colorToHex(app.applicationBuilder.branding.colors.text)};
     ...
     --c8y-nav-tabs-icon-color-default:${this.colorToHex(app.applicationBuilder.branding.colors.text)};
     --c8y-nav-tabs-icon-color-active: ${this.colorToHex(app.applicationBuilder.branding.colors.textOnActive)};
     --c8y-action-bar-color-actions-hover:${this.colorToHex(app.applicationBuilder.branding.colors.hover)};
     --header-hover-color: ${this.colorToHex(app.applicationBuilder.branding.colors.hover)};
  
     --navigator-color-active:  ${this.colorToHex(app.applicationBuilder.branding.colors.textOnPrimary)};
     --c8y-body-background-color: ${this.lighter(app.applicationBuilder.branding.colors.primary)};
     --brand-dark: ${this.colorToHex("#058192")};
...
.nav-tabs > li > button {
    color: var(--text-color,#0b385b) !important;
}
...
`;
            ...
            --c8y-nav-tabs-background-default: ${this.colorToHex(app.applicationBuilder.branding.colors.tabBar)};
            --header-hover-color: ${this.colorToHex(app.applicationBuilder.branding.colors.hover)};
        
            --navigator-color-active:  ${this.colorToHex(app.applicationBuilder.branding.colors.textOnPrimary)};
            --c8y-body-background-color: ${(app.applicationBuilder.selectedTheme == "Classic") ?  this.colorToHex("#f2f3f4") :
            this.lighter(app.applicationBuilder.branding.colors.primary)};
            ...
            --bf-card-bg: ${(app.applicationBuilder.selectedTheme == "Classic") ?  this.colorToHex("#fff") :
            this.colorToHex(app.applicationBuilder.branding.colors.primary)};
    ...
    private async loadFaviconURL(app) {
        await delay(1000);
        if (app.applicationBuilder.branding && app.applicationBuilder.branding.enabled && app.applicationBuilder.branding.colors) {
            const faviconUrl = this.createFaviconUrl(app.applicationBuilder.branding.colors.textOnPrimary, app.applicationBuilder.icon);
            this.favicon.setAttribute('type', 'image/png');
            this.favicon.setAttribute('href', faviconUrl);
        } else {
            const faviconUrl = this.createFaviconUrl('#1776BF', app.applicationBuilder.icon);
